...
def token_units(text: str) -> list[str]:
    """Language-agnostic tokenization for WER-like scoring.

    Latin words stay as words. Thai base characters carry following marks as one
    unit because Thai whitespace is phrase-like rather than word-like.
    """
